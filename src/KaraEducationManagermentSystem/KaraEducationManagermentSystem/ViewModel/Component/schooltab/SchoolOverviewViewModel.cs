...
namespace KaraEducationManagermentSystem.ViewModel.Component.schooltab
{
    class SchoolOverviewViewModel : ViewModelBase, IManageSchoolBase
    {

        private School m_SchoolObject;
        KaraMongodbModel m_Model;

        public SchoolOverviewViewModel()
        {
